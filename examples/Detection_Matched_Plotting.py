...
output_dir = '../data/TOC2ME_Data/Matched_Output'  #: Directory containing associated detected events JSON file
save_figures_dir = '../data/TOC2ME_Data/Matched_Output/DetectedEventsExample/'  #: Directory to save figures
...
num_examples_to_plot = 1  #: Number of random events to plot
