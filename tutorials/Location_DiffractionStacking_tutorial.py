...
All approaches - computation of :math:`F(\mathbf{r},t)`, :math:`S(\mathbf{r},t)` and :math:`S_w(\mathbf{r},t,W)` - 
are implemented in :py:class:`fracspy.location.migration.diffstack`.

Finally, assuming that there is only one event in the given time window, 
the actual volume of the image function is obtained by computing a maximum of the 4D image function.
...
print('True event hypocenter: [{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from absolute diffraction stacking: [{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_abs,[dx, dy, dz])))
print('Location error: [{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_abs, [dx, dy, dz])))
...
fig,axs = locimage3d(dstacked_abs_wn, 
                     ...
                     x0=sx, y0=sy, z0=sz,
                     xlim=xlim,ylim=ylim,zlim=zlim)
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from absolute diffraction stacking:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_abs_wn,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_abs_wn, [dx, dy, dz])))
...
fig,axs = locimage3d(dstacked_abs_sn, 
                     ...
                     xlim=xlim,ylim=ylim,zlim=zlim)
print('True event hypocenter: [{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from absolute diffraction stacking: [{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_abs_sn,[dx, dy, dz])))
print('Location error: [{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_abs_sn, [dx, dy, dz])))
...
fig,axs = locimage3d(dstacked_abs_rn, 
                     ...
                     xlim=xlim,ylim=ylim,zlim=zlim)
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from absolute diffraction stacking:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_abs_rn,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_abs_rn, [dx, dy, dz])))
...
fig,axs = locimage3d(dstacked_semb, 
                      ...
                      xlim=xlim,ylim=ylim,zlim=zlim)
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from semblance-based diffraction stacking:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_semb,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_semb, [dx, dy, dz])))
...
fig,axs = locimage3d(dstacked_semb_swin, 
                      ...
                      xlim=xlim,ylim=ylim,zlim=zlim)
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from semblance-based diffraction stacking  with sliding window:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_semb_swin,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_semb_swin, [dx, dy, dz])))
...
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from semblance-based diffraction stacking  with sliding window:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_semb_swin_wn,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_semb_swin_wn, [dx, dy, dz])))
...
fig.suptitle(f"Location with semblance-based diffraction stacking:\nsliding window of {swsize} samples,\ndata contaminated with spiky noise of SNR={snr_sn}")
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from semblance-based diffraction stacking  with sliding window:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_semb_swin_sn,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_semb_swin_sn, [dx, dy, dz])))
...
fig.suptitle(f"Location with semblance-based diffraction stacking:\nsliding window of {swsize} samples,\ndata contaminated with ringy noise of SNR={snr_rn}")
print('True event hypocenter:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply([sx, sy, sz],[dx, dy, dz])))
print('Event hypocenter from semblance-based diffraction stacking  with sliding window:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*np.multiply(hc_semb_swin_rn,[dx, dy, dz])))
print('Location error:\n[{:.2f} m, {:.2f} m, {:.2f} m]'.format(*get_location_misfit([sx, sy, sz], hc_semb_swin_rn, [dx, dy, dz])))
